      ...
      <View style={styles.container}>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.text}>
            ...
            de ellas consiste en apostarle al color rojo o al color negro. En el
            tablero de la ruleta existen 10 números rojos, 10 números negros y 2
            números verdes (cero y doble cero).{'\n\n'} Si un jugador apuesta a
            un color y el color aparece, él o ella gana la cantidad apostada. Si
            se muestra un color diferente, el jugador pierde el importe de la
            apuesta. Si aparece verde, gire la rueda nuevamente hasta que
            aparezca rojo o negro. Si este color es el color de la apuesta, el
            jugador no gana ni pierde. De lo contrario, se perderá el importe de
            la apuesta. {'\n\n'}Dos jugadores usan diferentes estrategias. Un
            jugador simplemente apuesta Bs. 1.‐ al color rojo cada vez. El otro
            jugador empieza apostando un Bs. 1.‐ al color rojo. Si la gana, la
            apuesta otro Bs.1. Sin embargo, si el pierde, el apuesta Bs. 2.‐ la
            próxima vez. Si el pierde otra vez, la apuesta Bs. 4.‐ Este jugador
            puede continuar doblando la apuesta hasta un límite de Bs. 500.‐ Si
            el pierde esta apuesta de Bs. 500.‐ el empieza apostando nuevamente.{' '}
          ...
          <Text style={styles.text}>
            A continuación se muestra las condiciones y el funcionamiento de la
            simulación.
          </Text>
        </View>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.text1}>
            ...
            {'\n'}
            <Text style={styles.boldText}> - Cantidad Inicial:</Text> Indica la
            cantidad inicial con la que se ingresa al juego.{'\n'}
            <Text style={styles.boldText}>- Apuesta:</Text> Se refiere a la
            cantidad apostada inicialmente.{'\n'}
            <Text style={styles.boldText}>- Color:</Text> Se refiere al color al
            que se va a apostar.{'\n'}
          </Text>
        </View>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.text1}>
            ...
            iteración actual.
            {'\n'}
            <Text style={styles.boldText}>- Cant:</Text> Representa la cantidad
            actual disponible para apostar.{'\n'}
            <Text style={styles.boldText}>- Apuesta:</Text> Refleja la cantidad
            actual de la apuesta.{'\n'}
            <Text style={styles.boldText}>- Aleatorio:</Text> Muestra el número
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.text1}>
            ...
            como se muestra en la tabla anterior, utilizando la fórmula cantidad
            de piezas/cantidad total.
            {'\n\n'}
